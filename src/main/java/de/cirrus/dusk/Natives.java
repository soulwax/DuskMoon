        ...
        switch (os) {
            ...
            case "windows":
                ...
                System.setProperty("net.java.games.input.librarypath",
                        new File("lib/natives/windows").getAbsolutePath());
                break;
            case "windows 10":
                System.setProperty("org.lwjgl.librarypath", new File("lib/natives/windows").getAbsolutePath());
                System.setProperty("net.java.games.input.librarypath",
