...
public class Screen {
    ...
    public void renderSubImage(final int xp, final int yp, final Image image, final int x, final int y,
            final int vwidth, final int vheight, final float scale, final int bits) {
     ...
     *                the mirror bits
     */
    public void renderSubImage(int xp, int yp, final Image image, final int x, final int y, final int vwidth,
            final int vheight, final float scale, final float alpha, final int bits) {
        xp -= xOffset;
        yp -= yOffset;
     ...
     *                the mirror bits
     */
    public void renderSubImageShadow(int xp, int yp, final Image image, final int vwidth, final int vheight,
            final float scale, final int bits) {
        xp -= xOffset;
        yp -= yOffset;
        Image target = image;
        if (bits > 0) {
